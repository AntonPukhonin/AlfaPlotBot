...
class Asset:
    ...
    def get_timeseries(self, indx):
        print indx
        if (indx == "AdjClose"):
            b = [datetime.datetime(2015, 1, 5, 10, 15), datetime.datetime(2015, 1, 5, 10, 30), datetime.datetime(2015, 1, 5, 10, 45), datetime.datetime(2015, 1, 5, 11, 0), datetime.datetime(2015, 1, 5, 11, 15), datetime.datetime(2015, 1, 5, 11, 30), datetime.datetime(2015, 1, 5, 11, 45), datetime.datetime(2015, 1, 5, 12, 0), datetime.datetime(2015, 1, 5, 12, 15), datetime.datetime(2015, 1, 5, 12, 30), datetime.datetime(2015, 1, 5, 12, 45), datetime.datetime(2015, 1, 5, 13, 0), datetime.datetime(2015, 1, 5, 13, 15), datetime.datetime(2015, 1, 5, 13, 30), datetime.datetime(2015, 1, 5, 13, 45), datetime.datetime(2015, 1, 5, 14, 0), datetime.datetime(2015, 1, 5, 14, 15), datetime.datetime(2015, 1, 5, 14, 30), datetime.datetime(2015, 1, 5, 14, 45), datetime.datetime(2015, 1, 5, 15, 0), datetime.datetime(2015, 1, 5, 15, 15), datetime.datetime(2015, 1, 5, 15, 30), datetime.datetime(2015, 1, 5, 15, 45), datetime.datetime(2015, 1, 5, 16, 0), datetime.datetime(2015, 1, 5, 16, 15), datetime.datetime(2015, 1, 5, 16, 30), datetime.datetime(2015, 1, 5, 16, 45), datetime.datetime(2015, 1, 5, 17, 0), datetime.datetime(2015, 1, 5, 17, 15), datetime.datetime(2014, 1, 5, 17, 30)]
